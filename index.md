...
**[Build your robot]({{site.baseurl}}{% link build.md %})**{: style="font-size: 20px"} Assembly instructions

**[Program your robot]({{site.baseurl}}{% link program.md %})**{: style="font-size: 20px"} Code your bot to fight
