...
**[Build your robot]({{site.baseurl}}{% link build.md %})**{: style="font-size: 35px; text-decoration: none;"} Assembly instructions

**[Program your robot]({{site.baseurl}}{% link program.md %})**{: style="font-size: 35px; text-decoration: none;"} Code your bot to fight
